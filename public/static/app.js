    ...
    <div class="animate-slideUp">
      ...
      <div class="glass rounded-xl p-4 mb-5">
        ...
        <div class="p-3 rounded-lg bg-night-900/30 border-l-2 border-amber-500/40 mb-2">
          ...
          <p class="text-xs text-gray-400 leading-relaxed mt-3"><strong>Le réflexe earworm :</strong> En écoutant régulièrement le refrain « Rêve Mieux », tu vas naturellement l'avoir en tête à des moments aléatoires de ta journée. C'est l'effet earworm qui travaille pour toi. <strong class="text-amber-300">À chaque fois que le refrain te revient en tête, fais immédiatement un test de réalité</strong> : compte tes doigts, lis un texte, vérifie l'heure. Tu transformes ainsi chaque earworm spontané en opportunité d'ancrage. Plus tu le fais, plus le lien « refrain = test de réalité » devient automatique, et plus ce réflexe a de chances de se déclencher aussi quand le refrain apparaît dans tes rêves.</p>
          <p class="text-xs text-gray-400 leading-relaxed mt-3"><strong>Le bénéfice nocturne :</strong> Au-delà de l'écoute en journée, ce même refrain peut servir d'indice sonore nocturne grâce au TLR Nocturne (voir ci-dessous). En programmant une alarme avec le refrain à volume ultra-faible pendant le sommeil paradoxal, le son est trop discret pour te réveiller, mais suffisant pour que ton cerveau endormi le capte et l'intègre dans le rêve en cours. Et comme il a été conditionné en journée avec le questionnement « suis-je en train de rêver ? », il peut provoquer un flash de lucidité spontané. L'étude de Northwestern (Konkoly et al., 2024) a validé cette approche.</p>
