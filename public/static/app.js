    ...
    <div class="animate-slideUp">
      ...
      <div class="glass rounded-xl p-4 mb-5">
        ...
        <div class="p-4 rounded-xl border border-amber-500/25 mb-4" style="background: linear-gradient(135deg, rgba(245,158,11,0.06), rgba(139,92,246,0.06));">
          ...
          <p class="text-xs text-gray-400 mb-2">Lancez le refrain pendant chaque contrôle de réalité pour créer l'association musique / questionnement.</p>
        ...
        <div class="space-y-2 mb-4">
          <div class="p-3 rounded-lg bg-night-900/30 border-l-2 border-dream-500/40">
            ...
            <p class="text-xs text-gray-400"><strong>Quoi faire :</strong> Regardez attentivement vos mains et comptez vos doigts un par un, en vous demandant sincèrement si vous rêvez.</p>
          ...
          <div class="p-3 rounded-lg bg-night-900/30 border-l-2 border-dream-500/40">
            ...
            <p class="text-xs text-gray-400"><strong>Quoi faire :</strong> Lisez un texte (panneau, écran, livre), détournez le regard, puis relisez-le. Demandez-vous : le texte est-il resté identique ?</p>
          ...
          <div class="p-3 rounded-lg bg-night-900/30 border-l-2 border-dream-500/40">
            ...
            <p class="text-xs text-gray-400"><strong>Quoi faire :</strong> Regardez une horloge ou une montre, détournez le regard, puis regardez à nouveau. L'heure est-elle cohérente ?</p>
        ...
        <div class="p-3 rounded-lg bg-night-900/30 border-l-2 border-amber-500/40 mb-2">
          ...
          <p class="text-xs text-gray-400 leading-relaxed"><strong>Le principe :</strong> Écoutez le refrain « Rêve Mieux » à chaque contrôle de réalité. L'objectif est de créer un conditionnement associatif entre la musique et le questionnement « suis-je en train de rêver ? ». Avec la répétition, votre cerveau associe les deux de manière automatique.</p>
