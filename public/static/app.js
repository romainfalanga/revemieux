  ...
  main.innerHTML = `
    <div class="animate-slideUp">
      ...
      <div class="glass rounded-xl p-4 mb-5">
        ...
        <p class="text-xs text-gray-300 leading-relaxed mb-3">
          <strong class="text-violet-200">Notre adaptation :</strong> Rêve Mieux n'intègre pas (encore) d'app TLR automatisée. Le guide ci-dessous te permet de <strong class="text-dream-300">reproduire le même principe manuellement</strong> avec l'appli Horloge de ton téléphone. Tu programmes une alarme avec le refrain « Rêve Mieux » comme sonnerie, à <strong class="text-dream-300">volume très bas</strong>, pour qu'elle sonne <strong class="text-dream-300">6 heures après ton coucher</strong> (pic de sommeil paradoxal). Comme ton cerveau a déjà associé ce refrain au questionnement « suis-je en train de rêver ? » via l'ancrage musical, le son peut s'intégrer dans ton rêve et déclencher la lucidité.
        </p>
        <p class="text-xs text-gray-300 leading-relaxed mb-3">
      ...
      <div class="space-y-3 mb-5">
        ...
        <div class="glass rounded-xl p-4">
          ...
          <div class="p-3 rounded-lg bg-emerald-900/15 border border-emerald-500/20 mb-3">
            <p class="text-[11px] font-semibold text-emerald-200 mb-1">🎵 Lien avec le TLR Nocturne (voir ci-dessus)</p>
